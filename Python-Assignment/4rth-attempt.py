...
class CurrencyApp:
    ...
    def create_page1(self):
        ...
        self.base_currency_entry.bind("<FocusOut>", self.close_suggestions_base)
        ...
        self.target_currency_entry.bind("<FocusOut>", self.close_suggestions_target)
        ...
        # Label for Amount
        self.amount_label = ttk.Label(self.frame1, text="Amount", font=("Helvetica", 12))
        ...
        self.suggestions_base.grid(row=5, column=0, columnspan=6, padx=10, pady=10)
        ...
        self.suggestions_target.grid(row=5, column=0, padx=10, pady=10)
        ...
        self.amount_entry.grid(row=4, column=0, padx=10, pady=5)
        ...
        self.notification_button.grid(row=9, column=0, columnspan=2, padx=10, pady=10)
    ...
    def close_suggestions_base(self, event):
        self.suggestions_base.grid_forget()

    def close_suggestions_target(self, event):
        self.suggestions_target.grid_forget()
